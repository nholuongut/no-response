...
# nholuongut: No Response

> a GitHub App built with [nholuongut](https://github.com/nholuongut/no-response) that closes Issues where the author hasn't responded to a request for more information.
...
```yml
# Configuration for nholuongut-no-response - https://github.com/nholuongut/no-response
